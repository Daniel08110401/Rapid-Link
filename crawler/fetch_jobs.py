...
from dotenv import load_dotenv
import os
from parsers.naver_parser import NaverParser  # Import the NaverParser class
...
def crawl_careers_page():
    # Crawl careers page using NaverParser
    naver_careers_page_url = "https://recruit.navercorp.com/rcrt/list.do?sw="
    parser = NaverParser(naver_careers_page_url)  # Create an instance of NaverParser

    # Fetch job list using the parser
    new_jobs = parser.list_parser(jobs_collection)
    return new_jobs
